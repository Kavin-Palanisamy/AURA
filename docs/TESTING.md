...
| **8** | **AI Settings & Validation (Day 4)** | Go to **Settings** tab, enter Gemini API key, and test **"Auto-Detect"**. | Queries API permissions, lists active models enabled for your account, and saves securely in `chrome.storage.local`. | 🟩 PASS |
